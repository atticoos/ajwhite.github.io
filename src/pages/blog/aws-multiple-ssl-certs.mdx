...
<img src="/static/images/blog/aws-multiple-ssl-certs/tls-handshake.png" alt="TLS handshake" />
...
<img src="/static/images/blog/aws-multiple-ssl-certs/load-balancer.jpg" alt="load balancing" />
...
<img src="/static/images/blog/aws-multiple-ssl-certs/dns-zones.jpg" alt="three DNS zones" />

We'll create a Load Balancer for each one of these domains to point to.

<img src="/static/images/blog/aws-multiple-ssl-certs/dns-zones-lbs.jpg" alt="three DNS zones mapped to three lbs" />

And then finally, we'll configure each one of these Load Balancers to point to the server.

<img src="/static/images/blog/aws-multiple-ssl-certs/dns-lb-proxy.jpg" alt="DNS load balancer proxy" />
